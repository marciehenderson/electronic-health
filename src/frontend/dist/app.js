...
function actionsView(subhash) {
    return __awaiter(this, void 0, void 0, function* () {
        let record = yield Promise.all([generateOptions('record_date', 'recordData'), generateOptions('patient_id', 'recordData')]);
        let patient = yield Promise.all([generateOptions('patient_id', 'clientData'), generateOptions('last_name', 'patientData'), generateOptions('first_name', 'patientData')]);
...
function generateOptions(column, variable) {
    return __awaiter(this, void 0, void 0, function* () {
